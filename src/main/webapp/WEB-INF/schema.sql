...
---MINE
drop table VOTE_SECTION if exists;
...
---MINE
create table VOTE_SECTION(ID integer identity primary key, CITY varchar(30), STREET varchar(30), NUMBER integer, unique(CITY, STREET));
