...
---MINE
insert into VOTE_SECTION(ID, CITY, STREET, NUMBER) values(1, 'Bucuresti', 'Govora', 7)
insert into VOTE_SECTION(ID, CITY, STREET, NUMBER) values(2, 'Bucuresti', 'Mariuca', 7)
insert into VOTE_SECTION(ID, CITY, STREET, NUMBER) values(3, 'Bucuresti', 'Tulnici', 5)
insert into VOTE_SECTION(ID, CITY, STREET, NUMBER) values(4, 'Bucuresti', 'Anton Bacalbasa', 5)
insert into VOTE_SECTION(ID, CITY, STREET, NUMBER) values(5, 'Bucuresti', 'Bd.Ion Mihalache', 5)
insert into VOTE_SECTION(ID, CITY, STREET, NUMBER) values(6, 'Bucuresti', 'Florin Radu', 5)
